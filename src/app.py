...
# Teacher credentials are stored in a JSON file for this exercise.
...
def load_teachers():
    ...
    try:
        ...
        raise RuntimeError("Invalid teachers.json file")
...
def require_teacher(authorization: str | None = Header(None, alias="Authorization")):
